<footer class="bg-dark">
    <div class="container d-flex flex-column align-items-center py-5">
        <a href="{{ route('homePage') }}"><img src="{{ asset(Lang::locale() === "ar" ? 'imgs/LifeSourceLogoWhite.png' : 'imgs/LifeSourceLogoAsciiWhite.png') }}" alt="LifeSource" height="40px"></a>
        ...
        <div class="findUsOnSocialMedia bg-dark d-flex justify-content-end align-items-center">
            <div class="social-btns">
                ...
                {{-- href="https://www.facebook.com/LifeSource"  --}}
                target="_blank">
                ...
                {{-- href="https://www.instagram.com/LifeSource/"  --}}
                target="_blank">
